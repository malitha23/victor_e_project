      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md pr-md-5 mb-4 mb-md-0">
            ...
            <div style="margin-bottom: 15px; padding-right:20px;"><p class="mb-4">At Vicstore, we ensure the best quality items, offering reliability, excellence, and customer satisfaction.</p></div>
            <div>
          ...
          <div class="col-md-3 mb-4 mb-md-0">
            ...
            <div class="row gallery">
              <div class="col-6">
                <a><img src="assets/images/footer/img.jpg" alt="Image" class="img-fluid"></a>
                <a><img src="assets/images/footer/img.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-6">
                <a><img src="assets/images/footer/img.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-12" style="margin-bottom: 15px;">
            ...
            <p>2025 Designed & Developed by  <a href="https://codyzea.com/" class="text-white">CODY ZEA SOFTWARE SOLUTIONS</a>, &nbsp;&nbsp;All rights reserved.</p>
            </div>
          </div>
