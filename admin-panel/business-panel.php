                    ...
                    <div class="container-fluid px-md-5">
                        ...
                        <div class="row">
                            <div class="col-12 text-center mb-0">
                                <div class="mb-1"><span class="h4 mb-9 fw-semibold">Add Cities&nbsp;&nbsp;<i class="fa fa-globe"
                                            aria-hidden="true"></i>
                                </div>
                        ...
                        <div class="row">
                            <div class="offset-1 col-10 offset-md-0 col-md-4 d-flex flex-row justify-content-center">
                                <img src="../admin-panel/assets-admin/images/contact/branch_i.svg" class="img-fluid"
                                    width="300px">
                            </div>
                                    ...
                                    <div class="col-12 shadow p-3 py-4">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-end">
                                                <button class="btn rounded-0-5 fw-bold x"><i
                                                        class="fa fa-check"></i>
                                                    SAVE</button>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 text-center mb-3">
                                <div class="mb-1"><span class="h4 mb-9 fw-semibold">Delivery Charges&nbsp;&nbsp;<i
                        ...
                        <div class="row mb-4">
                            <div class="offset-1 col-10 offset-md-0 col-md-4 d-flex flex-row justify-content-center order-md-2">
                                <img src="../admin-panel/assets-admin/images/contact/delivey_img.svg" class="img-fluid"
                                    width="300px">
                            </div>
                                ...
                                <div class="row d-flex flex-row justify-content-center align-items-center h-100">
                                    <div class="col-12 shadow p-3 py-4">
                                        <div class="row">
                                            <div class="col-6 col-md-4">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select rounded-0" id="c_id" onchange="list_dprice();"
                                                        aria-label="Floating label select example">
                                                        <option selected value="0" selected>Select a district</option>
                                                        <?php
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select rounded-0" id="c_id2" onchange="list_dprice();"
                                                        aria-label="Floating label select example">
                                                        <option selected value="0" selected>Select a district</option>
                                                        <?php
                                                        $district_q = Databases::search("SELECT * FROM `distric`");
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control rounded-0" id="d_price" value=""
                                                        placeholder="charges">
                                                    <label for="d_price">Delivery charges</label>
                                                </div>
                                            </div>
                                            <div class="col-12 text-end">
                                                <button class="btn rounded-0-5 fw-bold x" onclick="update_dprice();"><i
                                                        class="fa fa-check"></i>
                                                    SAVE</button>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 text-center mb-0">
                                <div class="mb-1"><span class="h4 mb-9 fw-semibold">Contact Us&nbsp;&nbsp;<i
                                            class="fa fa-envelope" aria-hidden="true"></i></span>
                                </div>
                        ...
                        <div class="row">
                            <div class="offset-1 col-10 offset-md-0 col-md-4 d-flex flex-row justify-content-center">
                                <img src="../admin-panel/assets-admin/images/contact/email_i.svg" class="img-fluid"
                                    width="300px">
                            </div>
                            <div class="col-12 col-md-8">
                                <div class="row d-flex flex-row justify-content-center align-items-center h-100">
                                    <div class="col-12 shadow p-3 py-4">
                                        <div class="row">
                                            <div class="form-floating mb-3">
                                                <input type="email" class="form-control rounded-0" id="contact_email"
                                                    value="name@example.com" placeholder="name@example.com">
                                                <label for="floatingInput">Email address</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="email" class="form-control rounded-0" id="contact_email"
                                                    value="+947785412" placeholder="name@example.com">
                                                <label for="floatingInput">Mobile Number</label>
                                            </div>
                                            <div class="col-12 text-end">
                                                <button class="btn rounded-0-5 fw-bold x" data-bs-toggle="modal"
                                                    onclick="change_email();" data-bs-target="#exampleModal"><i
                                                        class="fa fa-check"></i>
                                                    SAVE</button>
                                            </div>
                                        </div>
