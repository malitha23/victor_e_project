                                ...
                                <div class="card overflow-hidden rounded-2">
                                    <div class="position-relative p-4 d-flex flex-row align-items-center" style="height:12rem;">
                                        <a href="javascript:void(0)">
                                            <img src="assets-admin\images\products\s5.jpg" class="card-img-top rounded-0" alt="...">
                                        </a>
                                        <a href="javascript:void(0)" class="bg-green rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart">
                                            <i class="ti ti-basket fs-4"></i>
                                        </a>
                                    </div>
                                    <div class="card-body pt-3 p-4">
                                        <h6 class="fw-semibold fs-4">Example Product Title</h6>
                                                            ...
                                                            <div class="row d-flex justify-content-center">
                                                                <div class="col-8 col-md-4 mb-2" style="height: 200px;">
                                                                    ...
                                                                    <div class="border-x log-link d-flex justify-content-center align-items-center h-100 outer-div" id="di_1"
                                                                        onclick="uProductImage(1);"><span class="small" id="img_span_1">Image 1</span>
                                                                ...
                                                                <div class="col-8 col-md-4  mb-2" style="height: 200px;">
                                                                    ...
                                                                    <div class="border-x log-link d-flex justify-content-center align-items-center h-100" id="di_2"
                                                                        onclick="uProductImage(2);"><span class="small" id="img_span_2">Image 2</span>
                                                                ...
                                                                <div class="col-8 col-md-4 mb-2" style="height: 200px;">
                                                                    ...
                                                                    <div class="border-x log-link d-flex justify-content-center align-items-center h-100" id="di_3"
                                                                        onclick="uProductImage(3);"><span class="small" id="img_span_3">Image 3</span>
